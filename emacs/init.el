...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit counsel-projectile which-key use-package rainbow-delimiters projectile ivy-rich hydra helpful general ewal-doom-themes evil-collection doom-modeline counsel command-log-mode)))
(custom-set-faces
